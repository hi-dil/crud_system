<template>
    <div class="container mt-3 ">
        <div class="row">
            <div class="col">
                <p class="h3 text-success fw-bold">View User</p>
                <p class="fts-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure optio impedit a quisquam ex quod officiis eos, inventore sit! Aliquid ipsam sunt voluptatum aspernatur beatae ducimus, quas commodi voluptatem quisquam!</p>
            </div>
        </div>
    </div>
    <div class="container">
