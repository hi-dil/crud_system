    ...
    <div class="container mt-3 ">
        <div class="row">
            <div class="col">
                ...
                <p class="fts-italic">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perferendis vero cum illo doloremque impedit, nihil voluptas et consectetur repellat laudantium maiores reiciendis voluptatum quas doloribus, itaque quis, est debitis voluptatem.</p>
            </div>
        </div>
    </div>
    <div class="container mt-3 ">
