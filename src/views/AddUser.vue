<template>
    <div class="container mt-3 ">
        <div class="row">
            <div class="col">
                <p class="h3 text-success fw-bold">Add User</p>
                <p class="fts-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus nihil fugiat distinctio consequatur rem maxime dicta, quasi dolorum obcaecati perspiciatis consectetur libero aut quidem sit cupiditate commodi laborum enim nam.</p>
            </div>
        </div>
    </div>
    <div class="container mt-3 ">
